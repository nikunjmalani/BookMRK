...
SchoolSubcategoryModel schoolSubcategoryModelFromJson(String str) =>
    SchoolSubcategoryModel.fromJson(json.decode(str));

String schoolSubcategoryModelToJson(SchoolSubcategoryModel data) =>
...
class SchoolSubcategoryModel {
  ...
  factory SchoolSubcategoryModel.fromJson(Map<String, dynamic> json) =>
      SchoolSubcategoryModel(
        status: json["status"],
