  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<HomeScreenProvider>(
      builder: (context, data, child) {
        return Consumer<SchoolProvider>(builder: (_, _schoolProvider, child) {
                  ...
                  return Column(
                    children: [
                          ...
                          : SearchBar(
                              ...
                              onChanged: (value) {
                                if (value.length < 1) {
                                  ...
                                  snapshot.data[1].response[0].vendorSchool
                                      .forEach((e) {
                                    if (e.schoolName
                                        .toString()
                                        .toLowerCase()
                      ...
                      data.vendorSchoolIndex == 0
                          ...
                          : Expanded(
                              child: _schoolProvider.isSearchSchoolTabSelected
                                  ? ListView.builder(
                                      itemBuilder: (context, index) {
                                        return Padding(
                                          padding: index == 14
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemCount: snapshot.data[1].response[0]
                                          .vendorSchool.length,
                                    ),
                            ),
                    ],
