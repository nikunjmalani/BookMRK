...
class _UserAddAddressState extends State<UserAddAddress> {
  ...
  void resetControllers() {
    ...
    Provider.of<LocationProvider>(context, listen: false).selectedCountryId =
        null;
    Provider.of<LocationProvider>(context, listen: false).selectedStateName =
        "";
    Provider.of<LocationProvider>(context, listen: false).selectedStateId =
        null;
    Provider.of<LocationProvider>(context, listen: false).selectedCityName = "";
    Provider.of<LocationProvider>(context, listen: false).selectedCityId = null;
                ...
                builder: (_, _mapProvider, child) => Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      print(_secondAddressController.text);
                      if (_secondAddressController.text == "" ||
                        ...
                        if (response['status'] == 200) {
                          ...
                          if(Provider.of<HomeScreenProvider>(context, listen: false).selectAddressFirstTime){

                            int userId =
                            prefs.read<int>(
                                'userId');
                            dynamic response2 = await UserAPI
                                .changeSelectedUserAddress(
                                userId
                                    .toString(),
                                response['response'][0]['user_address_id'].toString());
                            print(response2);
                            if (response2[
                            'status'] ==
                                200) {
                              ...
                              Provider.of<HomeScreenProvider>(context, listen: false).blueCartIcon = true;
                              Provider.of<HomeScreenProvider>(context, listen: false).blueBellIcon = false;
                            } else {
